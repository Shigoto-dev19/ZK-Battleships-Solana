...
npx snarkjs powersoftau new bn128 15 ./circuits/artifacts/ptau/pot15_0000.ptau -v
...
npx snarkjs powersoftau contribute ./circuits/artifacts/ptau/pot15_0000.ptau ./circuits/artifacts/ptau/pot15_0001.ptau \
    --name="First contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
npx snarkjs powersoftau contribute ./circuits/artifacts/ptau/pot15_0001.ptau ./circuits/artifacts/ptau/pot15_0002.ptau \
    --name="Second contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
npx snarkjs powersoftau contribute ./circuits/artifacts/ptau/pot15_0002.ptau ./circuits/artifacts/ptau/pot15_0003.ptau \
    --name="Third contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"

# Verify
npx snarkjs powersoftau verify ./circuits/artifacts/ptau/pot15_0003.ptau
...
npx snarkjs powersoftau beacon ./circuits/artifacts/ptau/pot15_0003.ptau ./circuits/artifacts/ptau/pot15_beacon.ptau \
...
npx snarkjs powersoftau prepare phase2 ./circuits/artifacts/ptau/pot15_beacon.ptau ./circuits/artifacts/ptau/pot15_final.ptau -v

# Verify the final ptau file. Creates the file pot15_final.ptau
npx snarkjs powersoftau verify ./circuits/artifacts/ptau/pot15_final.ptau
